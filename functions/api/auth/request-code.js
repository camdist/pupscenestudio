...
async function verifyTurnstile(ctx,token){
  ...
  try{const r=await fetch('https://challenges.cloudflare.com/turnstile/v0/siteverify',{method:'POST',body:form});const j=await r.json();return !!j.success}catch(e){return false}
}
